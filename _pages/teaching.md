...
<div class="row">
	<div class="col">
		<h3>ECE 499 Engineering Project</h3>
	</div>
</div>
	...
	<div class="row">
		<div class="col">
			...
			You can find more information on outline.uwaterloo.ca for the current term <a href="https://outline.uwaterloo.ca">https://outline.uwaterloo.ca</a> or at the page below:
		</div>
	</div>
	...
	<div class="row mt-3">
		...
		<li class="list-group-item"> 
			<b>Every Term (4a/4b)</b> 
				<a href="/ece499/">ECE 499 Engineering Project</a>
		</li>
		</ul>
		</div>
		
	</div>
<!-- Add description and links for ECE 650 for W26 and F26 -->
<div class="row">
	<div class="col">
		<h3>ECE 650 Methods and Tools for Software Engineering</h3>
	</div>
</div>
...
<div class="row mt-3">
    ...
    <li class="list-group-item"> 
        <b>Winter 2026:</b> 
	 		<a href="https://outline.uwaterloo.ca/viewer/view/n95qvp">ECE 650 - Methods and Tools for Software Engineering</a>
		<b>Fall 2026:</b>		
            <a href="https://outline.uwaterloo.ca/author/edit/15233">ECE 650 - Methods and Tools for Software Engineering</a>
    </li>
    </ul>
    </div>
...
<div class="row">
	<div class="col">
		<h3>ECE 657A Introduction to Artificial Intelligence</h3>
	</div>
</div>
	...
	<div class="row mt-3">
		...
		<li class="list-group-item"> 
			<b>Winter 2026:</b> 
				<a href="https://outline.uwaterloo.ca/viewer/view/nn4m5v">ECE 657A - Introduction to Artificial Intelligence</a>
		</li>
		</ul>
		</div>
	</div>
...
<div class="row">
	<div class="col">
		<h3>ECE 475C : Reinforcement Learning</h3>
	</div>
</div>
...
<div class="row">
	<div class="col">
		<h3>ECE 457B: Computational Intelligence</h3>
	</div>
</div>
...
<div class="row">
	<div class="col">
		<h3>ECE 657A : Data Analysis and Machine Learning (DKMA)</h3>
	</div>
</div>
...
<div class="row">
	<div class="col">
		<h3>ECE 750 T40 : Topics in Reinforcement Learning</h3>
	</div>
</div>
